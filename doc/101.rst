  ...
  <installation> <!-- root element - entry point, initialization -->
    <welcome> <!-- expect welcome dialog to be present -->
      ...
      <!--
        ...
        unexpected state.
      -->
    </welcome> <!-- leaving welcome screen, wait for it to disappear -->
    ...
    <configuration> <!-- expect configuration screen -->
      <root_password> <!--
          enter root password spoke (same way as in case of partitioning)
        -->
        <password value="fo0m4nchU1" /> <!--
...
list of possible situations that could have happened and actions you should
 ...
 * There's `traceback.dump` and/or `traceback.log` file
    Some traceback occurred in anabot itself. This may be caused by some old

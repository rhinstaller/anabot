...
typedef struct _GpdContext GpdContext;
typedef struct _GpdSession GpdSession;
typedef struct _GpdStream GpdStream;
typedef struct _GpdEventController GpdEventController;

#if GPD_HAS_LIBEI
  typedef struct _GpdEiClient GpdEiClient;
#endif
